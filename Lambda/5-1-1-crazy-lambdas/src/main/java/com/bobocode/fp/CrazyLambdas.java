...
public class CrazyLambdas {
    ...
    public static Predicate<String> lengthInRangePredicate(int min, int max) {
        return (s)->s.length()>=min && s.length()<max? true:false;
    }
    ...
    public static IntUnaryOperator boundedRandomIntSupplier() {
        ...
        return (value)-> ThreadLocalRandom.current().nextInt( value + 1);
    }
    ...
    public static UnaryOperator<Function<String, String>> composeWithTrimFunction() {
        Function<String, String> firstCall = (str)->str.trim();

        return (secondCall)->secondCall.compose(firstCall);
    }
    ...
    return (intFunction, intCondition)-> (value)-> intCondition.test(value)==true?intFunction.applyAsInt(value):value;
        //throw new ExerciseNotCompletedException();
    }
    ...
    public static BiFunction<Map<String, IntUnaryOperator>, String, IntUnaryOperator> functionLoader() {
        ...
        return (biOperator, str)->biOperator.getOrDefault(str,IntUnaryOperator.identity());
     ...
     * @return a comparator instance
     */
    public static <T, U extends Comparable<? super U>> Comparator<T> thenComparing(  Comparator<? super T> comparator, Function<? super T, ? extends U> mapper) {


        return (a,b)->comparator.compare(a,b)==0?mapper.apply(a).compareTo(mapper.apply(b)):comparator.compare(a,b);
        //throw new ExerciseNotCompletedException();
    }
